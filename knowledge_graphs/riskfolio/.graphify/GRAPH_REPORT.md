...
## Corpus Check
- 13 files · ~95,672 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 394 nodes · 569 edges · 25 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output
- Edge kinds: calls: 187 · rationale_for: 165 · contains: 152 · method: 63 · inherits: 2
...
- `Portfolio` --inherits--> `object`  [EXTRACTED]
  src/Portfolio.py →   _Bridges community 4 → community 8_
...
## Knowledge Gaps
- **165 isolated node(s):** `r"""     Indicate if a matrix is positive (semi)definite.      Parameters     --`, `r"""     Generate a correlation matrix from a covariance matrix cov.      Parame`, `r"""     Generate a covariance matrix from a correlation matrix corr and a stand`, `r"""     Fix a covariance matrix to a positive definite matrix.      Parameters`, `r"""     Generate a matrix of returns that have a covariance matrix cov.      Pa` (+160 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 4`** (2 nodes): `Portfolio`, `r"""     Class that creates a portfolio object with all properties needed to`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 13`** (1 nodes): `r"""         Calculate the inputs that will be used by the optimization method w`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 15`** (1 nodes): `r"""         Calculate the inputs that will be used by the optimization method w`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 16`** (1 nodes): `r"""         Estimate the optimal scenario weights and comoments parameters usin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 17`** (1 nodes): `r"""         Calculate the inputs that will be used by the optimization method w`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 18`** (1 nodes): `r"""         This method that calculates the risk parity portfolio using the ris`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 19`** (1 nodes): `r"""         This method that calculates the MVSK portfolio using a semidefinite`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 20`** (1 nodes): `r"""         This method that calculates the owa optimal portfolio according to`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 21`** (1 nodes): `r"""         This method that calculates the risk parity portfolio using the ris`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 22`** (1 nodes): `r"""         This method that calculates the relaxed risk parity portfolio accor`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 23`** (1 nodes): `r"""         This method that calculates the worst case mean variance portfolio`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 24`** (1 nodes): `r"""         Calculate the inputs that will be used by the wc_optimization metho`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Portfolio` connect `Community 4` to `Community 8`, `Community 13`, `Community 14`, `Community 15`, `Community 11`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 9`, `Community 21`, `Community 22`, `Community 23`, `Community 24`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **What connects `r"""     Indicate if a matrix is positive (semi)definite.      Parameters     --`, `r"""     Generate a correlation matrix from a covariance matrix cov.      Parame`, `r"""     Generate a covariance matrix from a correlation matrix corr and a stand` to the rest of the system?**
