...
These are **point-in-time planning documents** from the project's early phases. They are kept
for history but are **superseded** and should not be read as the current state of the repo.
