<!-- generated by scripts/build_unified_index.py — do not edit; regenerate to update -->
...
| pyportfolioopt | — | 342 · 522 | 4 | [`pyportfolioopt`](../../skills/pyportfolioopt/SKILL.md) |
...
- [`statsmodels-statespace`](../../skills/statsmodels/statespace/SKILL.md) — Use when working with statsmodels state-space models — SARIMAX, DynamicFactor, UnobservedComponents, VARMAX, and custom MLEModel specifications with the Kalman filter.
...
- [`quant-backtesting-comparison`](../../skills/quant-patterns/backtesting-comparison/SKILL.md) — Use when choosing between backtrader and vectorbt for strategy backtesting — tradeoffs between event-driven flexibility and vectorized speed.
- [`quant-data-pipeline`](../../skills/quant-patterns/data-pipeline/SKILL.md) — Use when moving data between pandas, polars, and numpy — conversion, alignment, concatenation, and efficient cross-framework data flow for quant workloads.
...
- [`quant-feature-engineering`](../../skills/quant-patterns/feature-engineering/SKILL.md) — Use when creating features from price/volume data for ML models — technical indicators, statistical transforms, scaling, and dimensionality reduction.
...
- [`quant-metric-conventions`](../../skills/quant-patterns/metric-conventions/SKILL.md) — Use when auditing or combining performance metrics (drawdown, Sharpe, risk-free returns, annualization) produced by different Python quant libraries — empyrical, quantstats, pyfolio, backtrader, pyportfolioopt — in one report or pipeline.
...
- [`quant-risk-models`](../../skills/quant-patterns/risk-models/SKILL.md) — Use when building risk models and constructing portfolios — covariance estimation, constrained optimization, and risk-aware allocation across riskfolio, pyportfolioopt, and cvxpy.
- [`quant-time-series-ensemble`](../../skills/quant-patterns/time-series-ensemble/SKILL.md) — Use when combining multiple time series forecasting approaches — SARIMAX, GARCH, and darts models — into an ensemble for more robust predictions.
...
| catboost::CatBoostClassifier | scikit-learn::Pipeline | compatible_with |
| catboost::CatBoostClassifier | xgboost::XGBClassifier | alternative_to |
| catboost::CatBoostClassifier | lightgbm::LGBMClassifier | alternative_to |
| catboost::Pool | shap::Explainer | explains |
| catboost::CatBoostClassifier | optuna::Study | optimized_by |
| ta::add_all_ta_features() | pandas::DataFrame | consumes |
| ta::RSIIndicator | ta-lib::__pyx_pw_5talib_7_ta_lib_287RSI() | alternative_to |
| ta::MACD | vectorbt::SignalFactory | feeds |
| darts::TimeSeries | pandas::DataFrame | consumes |
| darts::ForecastingModel | statsmodels::OLS | alternative_to |
| darts::ForecastingModel | pymc::Model | alternative_to |
| darts::TimeSeries | yfinance::Ticker | feeds |
