...
description: Use when working with scikit-learn matrix decomposition and dimensionality reduction — PCA, NMF, TruncatedSVD, FactorAnalysis, FastICA, DictionaryLearning, and LatentDirichletAllocation.
version: 0.1.0
author: quant-kg-lab
license: MIT
...
graph_stats:
  nodes: 18753
  edges: 49978
  communities: [1, 153, 263, 287, 334, 360, 361]
metadata:
  hermes:
    tags: [scikit-learn, machine-learning, decomposition, dimensionality-reduction, pca, nmf, svd]
    related_skills: [scikit-learn-preprocessing, scikit-learn-linear-model]
---
