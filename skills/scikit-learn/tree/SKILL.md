...
description: "Use when working with scikit-learn Decision Trees \u2014 classification,\
  \ regression, visualization, and export. Covers core classes, methods, and quant-relevant\
  \ patterns."
version: 0.2.0
author: quant-kg-lab
license: MIT
