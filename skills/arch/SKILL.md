---
name: arch
description: "Use when working with arch — the volatility/unit-root entry point. Router indexing the arch sub-skills; load the sub-skill for the domain you need."
version: 0.2.0
author: quant-kg-lab
license: MIT
