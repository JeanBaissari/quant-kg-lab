---
name: quantstats
description: "Use when working with quantstats — the portfolio-analytics entry point. Router indexing the quantstats sub-skills; load the sub-skill for the layer you need."
version: 0.2.0
author: quant-kg-lab
license: MIT
