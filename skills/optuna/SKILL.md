---
name: optuna
description: Use when working with Optuna hyperparameter optimization framework. Covers
  samplers, pruners, study lifecycle, trial parameter suggestion, visualization, integrations,
  and distributions. Load sub-skills for domain-specific detail.
version: 0.2.0
author: quant-kg-lab
license: MIT
