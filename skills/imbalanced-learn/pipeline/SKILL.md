...
description: "Use when building sampling-aware pipelines with imblearn — Pipeline/make_pipeline that hold samplers between transformers and estimators, and the imbalanced scoring/metrics surface."
version: 0.2.0
author: quant-kg-lab
license: MIT
